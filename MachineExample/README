Read Me
Crazy Train Exercise: MachineExample (with Drools)
Implemented by Charles Smith

MachineExample is a Java project that uses drools to analyze 6 sample machines and provide lists
